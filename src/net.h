...
inline unit64_t int ReceiveFloodSize() { return 1000*GetArg("-maxreceivebuffer", 5*1000); }
inline unit64_t int SendBufferSize() { return 1000*GetArg("-maxsendbuffer", 1*1000); }
...
public:
    ...
    std::set<CAddress> vsetAddrknown;
    bool fGetAddr;
